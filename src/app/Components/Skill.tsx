...
const CardComponent = () => {
  return (
    <div className=" md:w-200  group border flex flex-col justify-center items-center border-gray-300 rounded-lg p-5  hover:shadow-xl  transition-all duration-300 transform hover:-translate-y-2">
