...
const Aboutme = () => {
    return (
        <section id='about' className='min-h-screen scroll-mt-24 mt-20 mb-18 p-5'>
            ...
            <p className="text-xl text-gray-700 text-center text-balance">Im a passionate full-stack developer with over 2 years of experience building web applications. I love turning complex problems into simple, beautiful, and intuitive solutions.</p>
